...
const Timer = () => {
  ...
  //     try {
  //       const resp = await axios.get("https://productivity-app-api-production.up.railway.app/UserSettings")
  ...
  const handleClearFinished = async (id) => {
    ...
    try {
      ...
      await axios.patch("https://productivity-app-api-production.up.railway.app/UserSettings/ClearCurrentTask/" + settingsId, { current_task: null, task_id: myId })
      if (dbTasks.length < 1) {
        //Reset count when empty task
        await axios.patch("https://productivity-app-api-production.up.railway.app/UserSettings/PomoCount/" + userId, { PomoCount: 0 })
  ...
  const handleClearAll = async () => {
    ...
    const userId = 1;
    try {
      await axios.post("https://productivity-app-api-production.up.railway.app/TaskCurrent/ClearAll")
